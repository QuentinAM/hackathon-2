...
<section class="stats-card">
    <div class="stats">
      <div class="each-stat">
        <h1 class="top">{money_earned}<p>usdc</p></h1>
        <p class="bot">/{goal} usdc</p>
      </div>
      <div class="vert-line1"></div>
      <div class="each-stat">
        <h1 class="top">{total_contributor}</h1>
        <p class="bot">total backers</p>
      </div>
      <div class="vert-line2"></div>
      <div class="each-stat">
        <h1 class="top">{day_left}</h1>
        <p class="bot">days left</p>
      </div>
    </div>
    <div class="bar">
      <hr class="hr1">
